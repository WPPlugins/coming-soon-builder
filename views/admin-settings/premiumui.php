         ...
         <tr valign='top'>
            ...
            <td>
               <div class="onoffswitch">
                    ...
                    <p class='description'><?php _e('To View ComingSoon page visit your website after logging out or in private window.') ;?></p>
           </td>
          </tr>
 ...
 <table class="form-table">
            ...
            <li>
              ...
              <li>
              <p class="pp" style='padding-left:2px;'>Pre-Launch <a href="http://web-settler.com/coming-soon"> Unlock Here</a> <input disabled type="radio" name="mmp_themes" id="mmp_theme6" value="pre-launch" <?php  checked('pre-launch',get_option('mmp_themes')); true ?>/></p>
